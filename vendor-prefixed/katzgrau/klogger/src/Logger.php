 ...
 */
namespace BrianHenryIE\WC_Set_Gateway_By_URL\Katzgrau\KLogger;
 ...
 *
 * Usage:
 * $log = new BrianHenryIE\WC_Set_Gateway_By_URL\Katzgrau\KLogger\Logger('/var/log/', Psr\Log\LogLevel::INFO);
